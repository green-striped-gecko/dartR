...
#'  number of missing values for each of several quantiles to assist the decision of choosing thresholds for the filter function \code{\link{gl.filter.callrate}}
#'
