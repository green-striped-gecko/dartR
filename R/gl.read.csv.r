...
#' 
#' The data need to be in one of two forms. SNPs can be coded 0 for homozygous reference, 2 for homozygous alternate, and 1 for heterozygous with NA for missing values, or
...
#' @examples
#'    gl <- gl.read.csv(filename="test.csv"]
