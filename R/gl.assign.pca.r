...
#' \item The ordination is repeated on the remaining populations to again yield a
#' series of orthogonal (independent) axes, a necessary condition for combining
#' likelihoods calculated from each axis.
...
# nmin=10, threshold=1,verbose=3) x <- gl.assign.pca(x, unknown='UC_00146', plevel=0.95, verbose=3)
