#' @name gl.collapse
#' @title Collapse a distance matrix by amalgamating populations with pairwise fixed difference count 
...
#' @param tpop -- threshold number of fixed differences above which populations will not be 
#' amalgamated [0]
...
# FUNCTION SPECIFIC ERROR CHECKING
  ...
  if (tpop < 0 ) {
    stop(error("Fatal Error: Parameter tpop should be a positive integer\n"))
  }  
