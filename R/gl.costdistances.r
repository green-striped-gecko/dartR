...
# CHECK IF PACKAGES ARE INSTALLED
  ...
  if (class(locs)=="genlight"){
    if (is.null(locs@other$latlon)){
      stop(error("No locations were provided in the genlight object [@other$latlon].\n"))
    }
    if (is.null(pop(locs))){
      cat(warn("No population definition provided, hence I will calculate costdistances between individuals\n"))
