...
#'
#' @details The function \code{\link{gl.filter.secondaries}} will filter out the loci with secondaries
#' retaining only one sequence tag.
#'  
...
# SAVE INTERMEDIATES TO TEMPDIR   
        if(save2tmp){
          ...
          glout <- tempfile(pattern = "gl.secondaries_")
      ...
      if(plot){cat(warning("  Warning: No loci with secondaries, no plot produced\n"))}
  }
