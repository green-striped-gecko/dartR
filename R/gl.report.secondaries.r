...
#'   one SNP (that is, with secondaries) and record them separately with the
...
#'   length of the sequence tags is 65 nucleotides. Based on the Poisson
...
#'   the total number of invariant sites. \strong{Note}, previous version of
