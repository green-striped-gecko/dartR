...
#' is, with secondaries) and record them separately with the same CloneID 
#' (=AlleleID). These multiple SNP loci within a fragment are likely to be 
#' linked, and so you may wish to remove secondaries.
#' 
