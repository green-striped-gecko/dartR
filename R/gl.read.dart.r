...
#' @param service the row number in which the information of the DArT service is contained [1]
#' @param plate the row number in which the information of the plate location is contained [3]
