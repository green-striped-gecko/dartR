...
#' 
#' In the output, it is also reported the number of loci used to estimate
#'  heterozygosity(nLoc), the number of polymorphic loci (polyLoc), the number
#'   of monomorphic loci (monoLoc) and loci with all missing data (all_NALoc).
#'
